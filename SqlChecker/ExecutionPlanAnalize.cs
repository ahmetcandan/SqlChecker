    ...
    public static List<AnalysisResult> AnalyzeExecutionPlan(string planXml)
    {
        ...
        try
        {
            ...
            if (warningNode is not null)
                ...
                {
                    string at0 = warning.Attributes?.Count > 0 ? warning.Attributes[0].Value : string.Empty;
                    string at1 = warning.Attributes?.Count > 1 ? warning.Attributes[1].Value : string.Empty;
                    string at2 = warning.Attributes?.Count > 2 ? warning.Attributes[2].Value : string.Empty;
